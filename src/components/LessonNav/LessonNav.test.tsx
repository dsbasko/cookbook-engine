...
describe('LessonNav', () => {
  ...
  it('records progress on next click when progress mode is enabled', () => {
    renderNav(PREV, NEXT);
    const nextLink = container.querySelectorAll('a')[1] as HTMLAnchorElement;
    act(() => {
  ...
  it('does not record progress on next click in free-reading mode', () => {
