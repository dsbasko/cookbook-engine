...
const PROGRESS_DISABLED_ATTR = 'data-progress-disabled';
...
describe('buildGateInitScript', () => {
  ...
  it('does not lock a far-future lesson when free-reading mode is enabled', () => {
    // progress-mode-init runs earlier and stamps data-progress-disabled; the
    // gate-init early exit must then leave a normally-locked lesson unlocked.
