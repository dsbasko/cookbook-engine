...
describe('buildGateMarkScript', () => {
  ...
  it('paints nothing when free-reading mode is enabled', () => {
    // With data-progress-disabled stamped on <html>, the early exit must skip
    // painting entirely: future rows that would normally be locked stay clean.
